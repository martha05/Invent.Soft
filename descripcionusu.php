...
<div class="container">
        <div class="menu">
            <a href="iniciousu.php" style="text-decoration:none; font-size:30px;"><h2>Descripcion Articulo</h2></a>
        </div>
        <div class="descrip">
        <table class="table table-border ">
            ...
            <a href="iniciousu.php" style="text-decoration:none; font-size:30px;"><h2>Especificación Articulo</h2></a>
            <table class="table table-border ">
                <thead>
                    <tr>
                        <th>Id</th>
            ...
            <a href="iniciousu.php" style="text-decoration:none; font-size:30px;"><h2>Ubicación Articulo</h2></a>
            <table class="table table-border ">
                <thead>
                    <tr>
                        <th>Id</th>
